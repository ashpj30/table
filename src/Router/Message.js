...
function Messagee() {
  ...
  const handlenotificationClick= () => {
   ...
   <div className='menudrawer'>
    ...
    <a href='/calendar'>
    <div
          className={activeTab === 'calendar' ? 'Calendar active' : 'Calendar'}
          style={{
            backgroundColor: activeTab === 'calendar' ? 'rgba(38, 132, 255, 1)' : 'transparent',
            borderRadius: '0px 50px 50px 0px',
            width: '70px',
            top: '22%',
            left: '0.1%',
    ...
    <img src={Calendar } alt='logo'style={{ width: '20px', height: '20px' }}  onClick={handleTabClick}/>
    </div>
    </a>
    ...
    <a href='/person'>
        ...
        <a href='/below'>
        <div
          className={activeTab === 'below' ? 'Below active' : 'Below'}
          style={{
            backgroundColor: activeTab === 'below' ? 'rgba(38, 132, 255, 1)' : 'transparent',
            borderRadius: '0px 50px 50px 0px',
            width: '70px',
            top: '31%',
            left: '0.1%',
          ...
          onClick={() => handleTabClick('below')}>
          <img src={Below} alt='logo' style={{ width: '20px', height: '20px' }} />
        </div>
        </a>
        ...
        <a href='/grid'>
        <div
          className={activeTab === 'grid' ? 'Grid active' : 'Grid'}
          style={{
            backgroundColor: activeTab === 'grid' ? 'rgba(38, 132, 255, 1)' : 'transparent',
            borderRadius: '0px 50px 50px 0px',
            width: '70px',
            top: '37%',
            left: '0.1%',
          ...
          <img src={Grid} alt='logo' style={{ width: '20px', height: '20px' }} />
        </div>
        </a>
    ...
    <a href='/message'>
        <div
          className={activeTab === 'message' ? 'Message active' : 'Message'}
          style={{
            backgroundColor: activeTab === 'message' ? 'rgba(38, 132, 255, 1)' : 'transparent',
            borderRadius: '0px 50px 50px 0px',
            width: '70px',
            top: '47%',
            left: '0.1%',
          ...
          <img src={Message} alt='logo' style={{ width: '20px', height: '20px' }} />
        </div>
        </a>
    ...
    <h1 style={{marginLeft: '150%'}}>MessagePage</h1>
